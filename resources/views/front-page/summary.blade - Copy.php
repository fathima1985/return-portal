						...
						<div class="card-body px-0 pb-0">	
							<div class="row result-wrapper section-form">
								<div class="container-fluid">				
									...
									@foreach($data['product'] as $key => $lineKey)
										@php
											$line_index = explode('_', $lineKey)
											
										@endphp
										@php
											$line_key = $line_index[0] 
										@endphp
										@php
											$order = $orders['items'][$line_key]
										@endphp									
							...
							<div class="card-body px-0 pb-0">	
								<div class="shipping-list">
									...
									<div class="form-group py-3 px-4 @if($data['ship_method'] != $key ) d-none @else active-selection @endif">								
										<input type="radio" name="ship_method" class="ship_method" value="{{$key}}" id="{{$key}}" @if($data['ship_method'] == $key ) checked="checked" @endif />
								...
								<div class="gls-wrapper" @if($data['ship_method'] != 'gls') style="display:none" @endif>
