...
<aside class="sidenav bg-gradient-primary  navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/images/Logo.png" class="navbar-brand-img h-100" alt="Deluxerie">        
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-lg" aria-hidden="true"></i>               
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('edit-profile') ? 'active' : '') }} " href="{{ url('edit-profile') }}">
            ...
            <span class="nav-link-text ms-1">Shipping Methods</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('edit-profile') ? 'active' : '') }} " href="{{ url('edit-profile') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('edit-profile') ? 'active' : '') }} " href="{{ url('edit-profile') }}">
           <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Create Return</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/logout')}}">
            <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-button-power text-lg" aria-hidden="true"></i> 
            </div>
